...
class Network:
    ...
    def get_output_for(self, *in_expr: TfExpression, return_as_list: bool = False, **dynamic_kwargs) -> Union[TfExpression, List[TfExpression]]:
        ...
        if 'function' in dynamic_kwargs: self._build_func = dynamic_kwargs['function'] #############################################
        #print(self._build_func.__code__.co_varnames)
        #print('noise_inputs' in self._build_func.__code__.co_varnames)
